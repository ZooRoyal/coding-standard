...
function constructor()
{
    ...
    sniffCommand="${scriptDirectory}/../../node_modules/eslint/bin/eslint.js --config=$eslintConfig --ignore-path=$eslintIgnore"
...
function show_help()
{
    ...
    echo "Add a .dontSniffJS file to <JS-DIRECTORIES> that should be ignored."
...
function fix_violations()
{
    ...
    then
        ...
        echo "Because this is a dry run violations will not really be fixed!"
    else
