 ...
 * This class is a copy of PHP_CodeSniffer\Standards\Generic\Sniffs\Commenting\DocCommentSniff.
 *
 * This Version allows for single line comments for annotations and PHPUnit @test annotations without comment.
 */
class DocCommentSniff
{
    // @codingStandardsIgnoreEnd
    /**
     * If this tags are present there is no need for a short description.
     *
     * @var string[]
     */
