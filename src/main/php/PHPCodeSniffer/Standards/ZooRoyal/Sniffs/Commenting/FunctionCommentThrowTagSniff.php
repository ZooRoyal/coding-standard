...
/**
 * Class FunctionCommentThrowTagSniff
 * This class is a copy of PHP_CodeSniffer\Standards\Squiz\Sniffs\Commenting\FunctionCommentThrowTagSniff. It contains
 * a patch which changes the amount of expected throws tags to at least the count of thrown exceptions found.
 */
class FunctionCommentThrowTagSniff
{
    /**
            ...
            if ($tokens[$nextToken]['code'] === T_NEW) {
                ...
                if ($currException !== false) {
                    ...
                    if ($endException === false) {
                        ...
                        $thrownExceptions[] =
                            $phpcsFile->getTokensAsString($currException, ($endException - $currException));
                    }
                }//end if
            } else {
